...
public class ItemRainbowBlubberBottle extends ItemFood {

	public ItemRainbowBlubberBottle(final int id) {
		super(id, 2, 2, false);
		this.setAlwaysEdible();
		this.setMaxStackSize(1);
		this.setCreativeTab(UnderWaterCraftTab.tabUnderWaterCraft);
		this.setUnlocalizedName(ItemInfo.RAINBOW_BLUBBER_BOTTLE_UNLOCALIZED_NAME);
	}
