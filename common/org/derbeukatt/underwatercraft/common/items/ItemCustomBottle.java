...
public class ItemCustomBottle extends ItemBucket {

	private String iconName;

	public ItemCustomBottle(final int id, final int blockId) {
		super(id, blockId);
	...
	public ItemStack onEaten(final ItemStack item, final World world,
		...
		if (!world.isRemote) {
			...
			if (this.iconName == ItemInfo.RAINBOW_BLUBBER_BOTTLE_UNLOCALIZED_NAME) {
				amplifier++;
			}
		...
		return item.stackSize <= 0 ? new ItemStack(Item.glassBottle) : item;
	}
