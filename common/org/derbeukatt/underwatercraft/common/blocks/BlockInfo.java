...
public class BlockInfo {
	...
	public static final String BLUBBER_KEY = "blubberfluidblock";
	public static final String BLUBBER_NAME = "Liquid Blubber";
	...
	public static final String RAINBOW_BLUBBER_KEY = "rainbowblubberfluidblock";

	public static final String RAINBOW_BLUBBER_NAME = "Liquid Rainbow Blubber";

	public static final String RAINBOW_BLUBBER_STILL_ICON = "rainbow_blubber_still";

	public static final String RAINBOW_BLUBBER_UNLOCALIZED_NAME = "rainbowblubber";
